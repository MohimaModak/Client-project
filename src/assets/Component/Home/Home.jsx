...
//           </div>
//           <div className='absolute inset-0 flex hidden md:block'>
//             <div className='relative left-[500px] top-[750px]'>
//               <img src={photo9} className="animate-spin-slow" />
//             </div>
//           </div>
//           <div className='absolute inset-0 flex hidden md:block'>
//             <div className='relative left-[400px] top-[96px]'>
//               <img src={photo9} className="animate-spin-slow" />
//             </div>
//           </div>
//           <div className='absolute inset-0 flex hidden md:block'>
//             <div className='relative left-[900px] top-[96px]'>
//               <img src={photo9} className="animate-spin-slow" />
//             </div>
//           </div>
//           <div className='absolute inset-0 flex hidden md:block'>
...
//         <div>
//           <div className="bg-gradient-to-tr from-blue-300 via-blue-100 to-blue-300  h-screen relative">
//             <div>
//               <div className='absolute inset-0 flex top-28 left-32'>
...
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-64 left-[100px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-orange-200 to-blue-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-200 "></span>
//                   </div>
...
//               <div className='absolute inset-0 flex top-44 left-[600px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-orange-200 to-blue-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-200 "></span>
//                   </div>
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-20 left-[400px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-orange-200 to-blue-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-200 "></span>
//                   </div>
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-[450px] left-[10px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-orange-200 to-blue-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-200 "></span>
//                   </div>
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-[800px] left-[10px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-orange-200 to-blue-200 relative">
//                   <div className="absolute inset-0 flex">
...
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-[400px] left-[300px]'>
...
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-[200px] left-[280px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-yellow-100 to-emerald-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-300 "></span>
//                   </div>
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-[650px] left-[500px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-yellow-100 to-emerald-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-300 "></span>
//                   </div>
//                 </span>
//               </div>
//               <div className='absolute inset-0 flex top-[650px] left-[700px]'>
//                 <span className="orbit w-8 h-8 border-2  rounded-full bg-gradient-to-tr from-pink-200 via-yellow-100 to-emerald-200 relative">
//                   <div className="absolute inset-0 flex">
//                     <span className="w-3 h-3 shadow-2xl shadow-slate-400 border-2  rounded-full bg-emerald-300 "></span>
//                   </div>
...
//       {/* footer  */}
//       <div className='bg-white border-t-8 border-dotted border-white relative  h-screen'>
